...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_HEX_MANIAC] = { _("Macabress"), 6 },
    [TRAINER_CLASS_AROMA_LADY] = { _("Aroma Lady"), 10 },
    [TRAINER_CLASS_RUIN_MANIAC] = { _("Archaeol"), 15 },
    ...
    [TRAINER_CLASS_NINJA_BOY] = { _("Sneaky Kid"), 3 },
    ...
    [TRAINER_CLASS_SAILOR] = { _("Qwilsquad"), 8 },
    ...
    [TRAINER_CLASS_FAIRY_LADY] = {_("Fairy Lady") },
    [TRAINER_CLASS_COOL_GIRL] = {_("Cool Girl") },
    [TRAINER_CLASS_WAITRESS] = {_("Waitress") },
    [TRAINER_CLASS_COOL_GUY] = {_("Cool Guy") },
    ...
    [TRAINER_CLASS_BRIGAND] = { _("Brigand"), 15 },
};
