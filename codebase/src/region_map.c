...
{
    [MAPSEC_CARABRUE_TOWN] = {MAP_GROUP(CARABRUE_TOWN), MAP_NUM(CARABRUE_TOWN), HEAL_LOCATION_CARABRUE_TOWN},
    [MAPSEC_FENNILAHL_TOWN] = {MAP_GROUP(FENNILAHL_TOWN), MAP_NUM(FENNILAHL_TOWN), HEAL_LOCATION_FENNILAHL_TOWN},
    [MAPSEC_GASTREE_CITY] = {MAP_GROUP(GASTREE_CITY), MAP_NUM(GASTREE_CITY), HEAL_LOCATION_GASTREE_CITY},
    [MAPSEC_CERAM_BASE_CAMP] = {MAP_GROUP(CERAM_BASE_CAMP), MAP_NUM(CERAM_BASE_CAMP), HEAL_LOCATION_CERAM_BASE_CAMP},
    [MAPSEC_GALECREST_CITY] = {MAP_GROUP(GALECREST_CITY), MAP_NUM(GALECREST_CITY), HEAL_LOCATION_GALECREST_CITY},
    [MAPSEC_SILVERSUN_CITY] = {MAP_GROUP(SILVERSUN_CITY), MAP_NUM(SILVERSUN_CITY), HEAL_LOCATION_SILVERSUN_CITY},
    [MAPSEC_PELLUCA_CITY] = {MAP_GROUP(PELLUCA_CITY), MAP_NUM(PELLUCA_CITY), HEAL_LOCATION_PELLUCA_CITY},
    [MAPSEC_MIRROH_BASE_CAMP] = {MAP_GROUP(MIRROH_BASE_CAMP), MAP_NUM(MIRROH_BASE_CAMP), HEAL_LOCATION_MIRROH_BASE_CAMP},
    [MAPSEC_WINTERLILY_HOLLOW] = {MAP_GROUP(WINTERLILY_HOLLOW), MAP_NUM(WINTERLILY_HOLLOW), HEAL_LOCATION_WINTERLILY_HOLLOW},
    [MAPSEC_RIVETSHORE_CITY] = {MAP_GROUP(RIVETSHORE_CITY), MAP_NUM(RIVETSHORE_CITY), HEAL_LOCATION_RIVETSHORE_CITY},
    [MAPSEC_VICTORY_CAPE] = {MAP_GROUP(CHAMPIONSHIP), MAP_NUM(CHAMPIONSHIP), HEAL_LOCATION_VICTORY_CAPE},

    [MAPSEC_ROUTE1] = {MAP_GROUP(ROUTE1), MAP_NUM(ROUTE1), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE2] = {MAP_GROUP(ROUTE2), MAP_NUM(ROUTE2), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE3] = {MAP_GROUP(ROUTE3), MAP_NUM(ROUTE3), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE3_UNDERPASS] = {MAP_GROUP(ROUTE3_UNDERPASS), MAP_NUM(ROUTE3_UNDERPASS), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE4] = {MAP_GROUP(ROUTE4), MAP_NUM(ROUTE4), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE5] = {MAP_GROUP(ROUTE5), MAP_NUM(ROUTE5), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE6] = {MAP_GROUP(ROUTE6), MAP_NUM(ROUTE6), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE7] = {MAP_GROUP(ROUTE7), MAP_NUM(ROUTE7), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE8] = {MAP_GROUP(ROUTE8), MAP_NUM(ROUTE8), HEAL_LOCATION_NONE},

    [MAPSEC_MT_CERAM] = {MAP_GROUP(MT_CERAM), MAP_NUM(MT_CERAM), HEAL_LOCATION_NONE},
    [MAPSEC_ANCIENT_CERAM] = {MAP_GROUP(ANCIENT_CERAM), MAP_NUM(ANCIENT_CERAM), HEAL_LOCATION_ANCIENT_CERAM},
    [MAPSEC_VILETHORN_WOODS] = {MAP_GROUP(VILETHORN_WOODS), MAP_NUM(VILETHORN_WOODS), HEAL_LOCATION_NONE},
    [MAPSEC_HOYA_RIVER_NORTH] = {MAP_GROUP(HOYA_RIVER_NORTH), MAP_NUM(HOYA_RIVER_NORTH), HEAL_LOCATION_NONE},
    [MAPSEC_HOYA_RIVER_SOUTH] = {MAP_GROUP(HOYA_RIVER_SOUTH), MAP_NUM(HOYA_RIVER_SOUTH), HEAL_LOCATION_NONE},
    [MAPSEC_MT_MIRROH_EXTERIOR] = {MAP_GROUP(MT_MIRROH_EXTERIOR), MAP_NUM(MT_MIRROH_EXTERIOR), HEAL_LOCATION_NONE},
    [MAPSEC_MIRROH_PEAK] = {MAP_GROUP(MIRROH_PEAK), MAP_NUM(MIRROH_PEAK), HEAL_LOCATION_NONE},
    [MAPSEC_LILY_POND] = {MAP_GROUP(LILY_POND), MAP_NUM(LILY_POND), HEAL_LOCATION_NONE},
    [MAPSEC_SSELEGANT] = {MAP_GROUP(SSELEGANT), MAP_NUM(SSELEGANT), HEAL_LOCATION_SSELEGANT},
    [MAPSEC_UNCHARTED_ISLAND] = {MAP_GROUP(UNCHARTED_ISLAND), MAP_NUM(UNCHARTED_ISLAND), HEAL_LOCATION_UNCHARTED_ISLAND},
    [MAPSEC_ANCIENT_CORMORIA_FINAL_ISLAND] = {MAP_GROUP(ANCIENT_CORMORIA_FINAL_ISLAND), MAP_NUM(ANCIENT_CORMORIA_FINAL_ISLAND), HEAL_LOCATION_ANCIENT_CORMORIA_FINAL_ISLAND},
    [MAPSEC_CHAMPIONSHIP_CORRIDOR] = {MAP_GROUP(CHAMPIONSHIP_CORRIDOR), MAP_NUM(CHAMPIONSHIP_CORRIDOR), HEAL_LOCATION_CHAMPIONSHIP_CORRIDOR},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_CARABRUE_TOWN:
        return FlagGet(FLAG_VISITED_CARABRUE_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    ...
    case MAPSEC_GASTREE_CITY:
        return FlagGet(FLAG_VISITED_GASTREE_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_CERAM_BASE_CAMP:
        return FlagGet(FLAG_VISITED_CERAM_BASE_CAMP) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_GALECREST_CITY:
        return FlagGet(FLAG_VISITED_GALECREST_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_PELLUCA_CITY:
        return FlagGet(FLAG_VISITED_PELLUCA_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_MIRROH_BASE_CAMP:
        return FlagGet(FLAG_VISITED_MIRROH_BASE_CAMP) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_WINTERLILY_HOLLOW:
        return FlagGet(FLAG_VISITED_WINTERLILY_HOLLOW) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_RIVETSHORE_CITY:
        return FlagGet(FLAG_VISITED_RIVETSHORE_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_VICTORY_CAPE:
        return FlagGet(FLAG_VISITED_VICTORY_CAPE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SILVERSUN_CITY:
        return FlagGet(FLAG_VISITED_SILVERSUN_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
