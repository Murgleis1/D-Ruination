...
const struct Tileset gTileset_TemplarMonastery =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_TemplarMonastery,
    .palettes = gTilesetPalettes_TemplarMonastery,
    .metatiles = gMetatiles_TemplarMonastery,
    .metatileAttributes = gMetatileAttributes_TemplarMonastery,
    .callback = NULL,
};
...
const struct Tileset gTileset_SnowCableCar =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_SnowCableCar,
    .palettes = gTilesetPalettes_SnowCableCar,
    .metatiles = gMetatiles_SnowCableCar,
...
const struct Tileset gTileset_AncientMirroh =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_AncientMirroh,
    .palettes = gTilesetPalettes_AncientMirroh,
    .metatiles = gMetatiles_AncientMirroh,
...
const struct Tileset gTileset_WinterlilyGym =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_WinterlilyGym,
    .palettes = gTilesetPalettes_WinterlilyGym,
    .metatiles = gMetatiles_WinterlilyGym,
...
const struct Tileset gTileset_ZarudeForest =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_ZarudeForest,
    .palettes = gTilesetPalettes_ZarudeForest,
    .metatiles = gMetatiles_ZarudeForest,
