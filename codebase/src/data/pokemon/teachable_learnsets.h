...
// === DREAMSTONE RUINATION CUSTOM SPECIES — TEACHABLE LEARNSETS ===
// Joustroll and Jousteel teachable lists are identical: the union of
// canonical Varoom + Escavalier TM lists with duplicates removed.
// This pool also applies post-evolution (Jousteel does not unlock new TMs).

static const u16 sJoustrollTeachableLearnset[] = {
    MOVE_ACID_SPRAY,
    MOVE_ENDURE,
    MOVE_FACADE,
    MOVE_FLASH_CANNON,
...
static const u16 sJousteelTeachableLearnset[] = {
    MOVE_ACID_SPRAY,
    MOVE_ENDURE,
    MOVE_FACADE,
    MOVE_FLASH_CANNON,
