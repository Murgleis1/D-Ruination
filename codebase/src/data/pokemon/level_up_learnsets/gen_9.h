...
// Dreamstone Ruination — Frigibax line shared learnset
// All three stages share the same level-up backbone (uniquely-bred Cormorian variant)
// except Arctibax which additionally learns Ice Fang at Lv 0 on evolution.
// Mountain Gale is excluded from level-up; it is taught by the Master Tutor at Lv 45+
// and acts as the Arctibax -> Baxcalibur evolution trigger.
static const struct LevelUpMove sFrigibaxLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(65, MOVE_SNOWSCAPE),
    LEVEL_UP_MOVE(77, MOVE_BEHEMOTH_BLADE),
    LEVEL_UP_END
};
...
// === DREAMSTONE RUINATION CUSTOM SPECIES — LEARNSETS ===
// Joustroll and Jousteel are always compiled (no P_FAMILY_ guard).

static const struct LevelUpMove sJoustrollLevelUpLearnset[] = {
...
static const struct LevelUpMove sJousteelLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(73, MOVE_KOWTOW_CLEAVE),
    LEVEL_UP_MOVE(80, MOVE_RAZOR_SHELL),
    LEVEL_UP_MOVE(100, MOVE_MIGHTY_CLEAVE),
    LEVEL_UP_END
};
