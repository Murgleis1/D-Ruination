...
const u32 gObjectEventPic_TMHMBall[] = INCBIN_U32("graphics/object_events/pics/misc/ball_tmhm.4bpp");
...
const u32 gObjectEventPic_ProfTenebris[] = INCBIN_U32("graphics/object_events/pics/custom/prof_tenebris.4bpp");