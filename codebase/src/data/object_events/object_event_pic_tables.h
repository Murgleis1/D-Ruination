...
static const struct SpriteFrameImage sPicTable_TMHMBall[] = {
    ...
    overworld_frame(gObjectEventPic_TMHMBall, 2, 4, 1),
    overworld_frame(gObjectEventPic_TMHMBall, 2, 4, 2),
    overworld_frame(gObjectEventPic_TMHMBall, 2, 4, 3),
    overworld_frame(gObjectEventPic_TMHMBall, 2, 4, 4),
    overworld_frame(gObjectEventPic_TMHMBall, 2, 4, 0),
};
