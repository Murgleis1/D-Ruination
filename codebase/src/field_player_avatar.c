...
static const u16 sRivalAvatarGfxIds[][5] =
{
    ...
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_RIVAL_BRENDAN_ACRO_BIKE,  OBJ_EVENT_GFX_RIVAL_MAY_ACRO_BIKE,  OBJ_EVENT_GFX_MUNUCU_ACRO_BIKE,  OBJ_EVENT_GFX_SHUBUBU_ACRO_BIKE,  OBJ_EVENT_GFX_GUBUKING_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_RIVAL_BRENDAN_SURFING,    OBJ_EVENT_GFX_RIVAL_MAY_SURFING,    OBJ_EVENT_GFX_MUNUCU_SURFING,    OBJ_EVENT_GFX_SHUBUBU_SURFING,    OBJ_EVENT_GFX_GUBUKING_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_BRENDAN_UNDERWATER,       OBJ_EVENT_GFX_MAY_UNDERWATER,       OBJ_EVENT_GFX_MUNUCU_UNDERWATER, OBJ_EVENT_GFX_SHUBUBU_UNDERWATER, OBJ_EVENT_GFX_GUBUKING_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE, OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE, OBJ_EVENT_GFX_MUNUCU_FIELD_MOVE, OBJ_EVENT_GFX_SHUBUBU_FIELD_MOVE, OBJ_EVENT_GFX_GUBUKING_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_BRENDAN_FISHING,          OBJ_EVENT_GFX_MAY_FISHING,          OBJ_EVENT_GFX_MUNUCU_FISHING,    OBJ_EVENT_GFX_SHUBUBU_FISHING,    OBJ_EVENT_GFX_GUBUKING_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_BRENDAN_WATERING,         OBJ_EVENT_GFX_MAY_WATERING,         OBJ_EVENT_GFX_MUNUCU_WATERING,   OBJ_EVENT_GFX_SHUBUBU_WATERING,   OBJ_EVENT_GFX_GUBUKING_WATERING},
...
static const u16 sPlayerAvatarGfxIds[][5] =
{
    ...
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE,  OBJ_EVENT_GFX_MAY_ACRO_BIKE,  OBJ_EVENT_GFX_MUNUCU_ACRO_BIKE,  OBJ_EVENT_GFX_SHUBUBU_ACRO_BIKE,  OBJ_EVENT_GFX_GUBUKING_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_BRENDAN_SURFING,    OBJ_EVENT_GFX_MAY_SURFING,    OBJ_EVENT_GFX_MUNUCU_SURFING,    OBJ_EVENT_GFX_SHUBUBU_SURFING,    OBJ_EVENT_GFX_GUBUKING_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_MUNUCU_UNDERWATER, OBJ_EVENT_GFX_SHUBUBU_UNDERWATER, OBJ_EVENT_GFX_GUBUKING_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE, OBJ_EVENT_GFX_MAY_FIELD_MOVE, OBJ_EVENT_GFX_MUNUCU_FIELD_MOVE, OBJ_EVENT_GFX_SHUBUBU_FIELD_MOVE, OBJ_EVENT_GFX_GUBUKING_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_BRENDAN_FISHING,    OBJ_EVENT_GFX_MAY_FISHING,    OBJ_EVENT_GFX_MUNUCU_FISHING,    OBJ_EVENT_GFX_SHUBUBU_FISHING,    OBJ_EVENT_GFX_GUBUKING_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_BRENDAN_WATERING,   OBJ_EVENT_GFX_MAY_WATERING,   OBJ_EVENT_GFX_MUNUCU_WATERING,   OBJ_EVENT_GFX_SHUBUBU_WATERING,   OBJ_EVENT_GFX_GUBUKING_WATERING},
    [PLAYER_AVATAR_STATE_VSSEEKER]   = {OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE, OBJ_EVENT_GFX_MAY_FIELD_MOVE, OBJ_EVENT_GFX_MUNUCU_FIELD_MOVE, OBJ_EVENT_GFX_SHUBUBU_FIELD_MOVE, OBJ_EVENT_GFX_GUBUKING_FIELD_MOVE},
};
...
static const u16 sPlayerAvatarGfxToStateFlag[GENDER_COUNT][5][2] =
{
    ...
    [MUNUCU] =
    {
        {OBJ_EVENT_GFX_MUNUCU_NORMAL,         PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_MUNUCU_MACH_BIKE,      PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_MUNUCU_ACRO_BIKE,      PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_MUNUCU_SURFING,        PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_MUNUCU_UNDERWATER,     PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [SHUBUBU] =
    {
        {OBJ_EVENT_GFX_SHUBUBU_NORMAL,         PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_SHUBUBU_MACH_BIKE,      PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_SHUBUBU_ACRO_BIKE,      PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_SHUBUBU_SURFING,        PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_SHUBUBU_UNDERWATER,     PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [GUBUKING] =
    {
        {OBJ_EVENT_GFX_GUBUKING_NORMAL,         PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_GUBUKING_MACH_BIKE,      PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_GUBUKING_ACRO_BIKE,      PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_GUBUKING_SURFING,        PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_GUBUKING_UNDERWATER,     PLAYER_AVATAR_FLAG_UNDERWATER},
    }     
};
...
static void PlayerNotOnBikeMoving(u8 direction, u16 heldKeys)
{
    ...
    && FlagGet(FLAG_SYS_B_DASH) && IsRunningDisallowed(gObjectEvents[gPlayerAvatar.objectEventId].currentMetatileBehavior) == 0)
    {
        if (gRunToggleBtnSet)
        {
            ...
            if (FlagGet(FLAG_SYS_RUNNING_SHOES_TOGGLE) == FALSE)
            {
                FlagSet(FLAG_SYS_RUNNING_SHOES_TOGGLE);
                PlayerRun(direction);
                gPlayerAvatar.flags |= PLAYER_AVATAR_FLAG_DASH;
                return;
            }
            ...
            {
                FlagClear(FLAG_SYS_RUNNING_SHOES_TOGGLE);
                gRunToggleBtnSet = FALSE;
...
u8 GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
    ...
    case OBJ_EVENT_GFX_MUNUCU_SURFING:
    case OBJ_EVENT_GFX_MUNUCU_FIELD_MOVE:
    ...
    case OBJ_EVENT_GFX_SHUBUBU_SURFING:
    case OBJ_EVENT_GFX_SHUBUBU_FIELD_MOVE:
    ...
    case OBJ_EVENT_GFX_GUBUKING_SURFING:
    case OBJ_EVENT_GFX_GUBUKING_FIELD_MOVE:
