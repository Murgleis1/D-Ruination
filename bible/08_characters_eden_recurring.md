...
- **Level cap:** **early 80s** (peer-level fight, not above-cap). Specific level **~L83 `[LOCKED v0.9.9]`** (opener Solara ~L80, closing ace Gouging Fire ~L85). The Roaring Moon / Walking Wake L120 above-cap precedent is *not* applied here — Sable's Gouging Fire is *constrained-Mythical*, scaled to L80-85 to match the encounter and the player's natural team level at that point in the story.
- **Combat structure:** standard 6v6 single-trainer battle, no doubles. **Sable leads with Solara** (his elder-statesman opener — uses Solara to feel out the player's strategy) and **finishes with Gouging Fire** (the cleanup sweeper). The four middle slots are **`[LOCKED v0.9.9]`** — a sun-based mono-Fire order (full roster below); every pick was audited against the roster so none duplicates another major trainer's Fire-type.

| Pokémon | Type | Ability | Item | Moves | Role |
|---|---|---|---|---|---|
| **Solara** (Pyroar) | Fire/Normal | Unnerve | Throat Spray | Hyper Voice / Flamethrower / Noble Roar / Will-O-Wisp | The opener — softens and feels out the foe |
| **Ninetales** | Fire | Drought | Heat Rock | Nasty Plot / Flamethrower / Solar Beam / Will-O-Wisp | The sun engine; Solar Beam answers Water/Ground/Rock |
| **Talonflame** | Fire/Flying | Gale Wings | Heavy-Duty Boots | Swords Dance / Flare Blitz / Brave Bird / Roost | Priority cleanup + the team's Ground immunity |
| **Hisuian Typhlosion** | Fire/Ghost | Blaze | Choice Specs | Eruption / Infernal Parade / Solar Beam / Shadow Ball | Spectral ancient flame; Eruption nukes under sun |
| **Camerupt** | Fire/Ground | Sheer Force | Life Orb | Eruption / Earth Power / Flamethrower / Yawn | Stoic volcano; Earth Power covers Rock and Steel |
| **Gouging Fire** | Fire/Dragon | Protosynthesis | Lum Berry | Dragon Dance / Flare Blitz / Breaking Swipe / Earthquake | The closing ace — Protosynthesis fires under Ninetales' sun, then Dragon Dance sweeps |

**The sun spine `[LOCKED v0.9.9]`:** Ninetales' Drought is the team's engine and Sable's signature *atmosphere* — it powers every Fire move, halves incoming Water (softening the mono-Fire team's worst weakness for everyone), turns Solar Beam into an instant answer to Water/Ground/Rock, and triggers **Gouging Fire's Protosynthesis**, so the ace he is grooming reaches full power in the weather his oldest companions make for him. The mono-Fire coverage holes are all answered without leaving the type: Ground by Talonflame's Flying immunity and Camerupt's Earth Power, Water by the sun and Solar Beam, Rock by Camerupt. Thematically every member is dignified or ancient — a regal lion, a wise sun-fox, a noble falcon, a spectral Hisuian flame, a stoic volcano, and the primordial Paradox ace — an elder's harmonious order with no jostling for primacy.
...
- His *only* in-game appearance is as a **trainer fight inside a PTSD dream sequence**, locked to the **first meeting with the Blue Moon Hermit (Lethys) — the Trial 6-chapter ritual (~L45, Act II) where the starter's Stage-3 evolution technique is taught `[LOCKED v0.9.9]`** (the partnership-readiness ritual; see Section 10 — Manus Surge arc-role, and Section 11 — Lethys). The dream-fight against dream-Boran *is* the ritual's challenge: overcoming the internalized 'Pokémon are weapons' voice is what certifies Osrid ready, and the Stage-3 evolution is the reward.
...
- ~~Boran's dream-sequence team `[OPEN]`~~ — **RESOLVED v0.9.9 — "the war machine":** a 6v6 cold-deployment Electric arsenal at **~L45** (singles), built entirely from Electric Pokémon his father Manus does *not* use, and the deliberate anti-thesis of Manus's bonded, patient, status-control Trial-3 team. The strategy *is* the man — six single-purpose weapons, maximal firepower, zero bond, zero synergy:

| # | Pokémon | Type | Ability | Item | Moves |
|---|---|---|---|---|---|
| **1** | Regieleki (shiny) | Electric | Transistor | Choice Specs | Thunderbolt / Volt Switch / Thunder / Ancient Power |
| **2** | Magnezone | Electric/Steel | Magnet Pull | Choice Specs | Thunderbolt / Flash Cannon / Volt Switch / Tri Attack |
| **3** | Electivire | Electric | Motor Drive | Choice Band | Wild Charge / Ice Punch / Earthquake / Volt Switch |
| **4** | Luxray | Electric | Intimidate | Choice Band | Wild Charge / Crunch / Ice Fang / Volt Switch |
| **5** | Manectric | Electric | Lightning Rod | Choice Specs | Volt Switch / Flamethrower / Thunderbolt / Overheat |
| **6** | Jolteon | Electric | Volt Absorb | Choice Scarf | Thunderbolt / Volt Switch / Shadow Ball / Hyper Voice |

- **The numbered "names":** Boran refuses to call his Pokémon by species or name — each carries only a **serial number** as its nickname (**"1"** through **"6"**, in the order above). This *refines* the original "no named Pokémon" sketch into something sharper: serial numbers are anti-bond naming, the precise inverse of Manus teaching Modal to *write its own words*. Where Manus has a friend who answers in scorched script, Boran has six interchangeable, serial-stamped munitions.
- **The one shiny (a refinement of the original "no shiny" sketch):** ace **"1" is a shiny Regieleki** — read not as sentiment but as *materiel*: the military fields the single most powerful specimen it can acquire, a will-less energy-construct locked by Choice Specs into one maximal function. The shiny coloration is incidental to its role as the apex weapon, not a sign of a bond — the anti-bond ace by design (Section 11 anti-pattern exclusion; the inverse of Manus + Modal).
- **Mechanical thesis:** every Pokémon is **Choice-locked** — single-function weapons fired without thought — with **Volt Switch** on nearly all for "fire-and-rotate" unit-trading, and **no status, recovery, or mutual support** (the lone "support," Luxray's Intimidate, is itself a *domination* move). Coverage is raw and total: Magnet Pull Magnezone traps and executes the Steel walls; Electivire's Ice/Ground and Manectric's Fire break the Grounds and Grasses that resist Electric; Luxray's Crunch and Jolteon's Shadow Ball answer Ghosts/Psychics. All abilities and moves are **native** (no overrides).
- **The intended counterplay (the weld):** his doctrine is overwhelming but *rigid* — every weapon locked into one move. The adaptable, bonded player dismantles that rigidity, which is exactly what the Hermit ritual exists to certify before granting the Stage-3 evolution. Osrid overcomes the man who taught him by having become the thing that man refused to be. Its *effectiveness-without-sentiment* is the character the original sketch called for — now expressed through six cold, serial-numbered guns rather than blank ordinariness.

~~`[OPEN]` Specific placement of the PTSD dream-sequence fight~~ — **RESOLVED v0.9.9**: locked to the first Blue Moon Hermit meeting — the Trial 6-chapter Stage-3-evolution ritual (~L45, Act II); consistent with Section 17's prior placement lock.
