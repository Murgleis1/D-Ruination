...
- ~~**Madame Roma's overworld ace**~~ — **RESOLVED v0.9.9**: shiny Munkidori "Tiresias" (Toxic Chain), her astral-plane spirit-guide; full control/clock combat team locked (Munkidori / Sigilyph / Jirachi / Spectrier / Flutter Mane / Cradily). Interaction tone *measured, oracular, with surprising flashes of warmth*.
...
- ~~**Kimaris's post-Champion true-team side quest**~~ — **RESOLVED v0.9.9 (roster)**: Marshadow-led Reserve-Champion team locked — Marshadow / Mega Gengar / Dragapult / Mimikyu / Gholdengo / Houndstone (~L100). Parallel to Sable's Shiny Charm side quest. Remaining `[OPEN]`: dialog and reward. See Section 10 — Kimaris; engineering task #72.
...
- ~~**Madame Roma's overworld ace species/name/combat profile**~~ — **RESOLVED v0.9.9**: shiny Munkidori "Tiresias"; full combat team locked (see Section 11).
...
- **4 ace locks are `[OPEN]`** for the 23 in-scope characters: T5 Raptora, T6 Alban, T7 Nightfall, Blue Moon Hermit. (Manus's **Modal**, Jordan's **Naga**, Wakahisa's **Hayate**, Silas's **Thauma** + **Malamar**, and Roma's **Tiresias** (Munkidori) locked v0.9.9.) Each unlock cascades to enable the corresponding interaction sub-task (engineering task #56).
...
- ~~**Madame Roma's Pokemon team**~~ — **RESOLVED v0.9.9**: full control/clock team locked (see Section 11 — Madame Roma's overworld ace).
