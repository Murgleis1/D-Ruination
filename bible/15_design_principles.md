...
| 3 | Manus Surge | Trial Baron 3 (Electric) | **Modal** (shiny Toxtricity, custom Poison Puppeteer — single ace; **parental-and-warm register**: with Modal he is *calm* where he is volatile everywhere else — he pets, feeds, and talks to him, and Modal answers by *scorching written words* into paper and dirt with his own current — the scholarly intimacy of two old friends passing notes, and the direct rebuttal of Boran's bondlessness) | Locked v0.9.9 |
